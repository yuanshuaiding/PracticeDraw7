    ...
    protected void onAttachedToWindow() {
        ...
        animateBt.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                PropertyValuesHolder propertyValuesHolder = PropertyValuesHolder.ofKeyframe("progress", k1, k2, k3);
                ObjectAnimator.ofPropertyValuesHolder(view, propertyValuesHolder).setDuration(1000).start();
            }
        });
    }
}
